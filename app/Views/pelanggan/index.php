...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= base_url(); ?>/vendor/css/adminlte.min.css">
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
        ...
        footer {
            background-color: rgba(20, 50, 100, .8);
            text-align: center;
        }
...
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                <li class="logo">
                    <h2>DS Photography</h2>
                </li>
                <li class="menu-toggle">
                    <button onclick="toggleMenu();">&#9776;</button>
                </li>
                <li class="menu-item hidden"><a href="#">Halaman Utama</a></li>
                <li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Masuk</a>
                <li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Daftar</a>
                </li>
            </ul>
        </div>
    </header>
